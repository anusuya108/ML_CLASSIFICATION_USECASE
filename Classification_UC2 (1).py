...
@st.cache_resource
def load_uc2():
    model = joblib.load("uc2_model.pkl")   # Joblib-saved model
    return model

uc2_model = load_uc2()

st.title("🛒 Cart Abandonment Risk Prediction (UC2)")
st.write("Predict whether a customer is at **High Risk of Cart Abandonment** based on behavioral and transaction features.")
...
Discount_Usage_Rate = st.number_input("Discount Usage Rate (0–1)", min_value=0.0, max_value=1.0, value=0.4)
